...
Public Class Form1
    ...
    Private testCnt As Integer
    Private zeroCnt As Integer
    Private Maxloss As Integer
    Private GesMaxloss As Integer
    Private CntGewinn As Integer
    Private CntVerlust As Integer
    Private MaxSaldo As Integer
    Private MinSaldo As Integer
    Private testsaldo As Integer
    Private lastsaldo As Integer
    Private datum As String
    Private ResTxt As String
    Private FilterDatum As String = ""
    Private gesSaldoVerlauf As String = ""
    Private gesSaldoVerlaufNoZero As String = ""
    ...
    Private Sub ReadINIColSize()
        ...
        With DataGridView1
            ...
            .Columns(ColNum.eTPR6).Width = INI.WertLesen("ColSize", "TPR6", "65")
            ...
            .Columns(ColNum.eTMR6).Width = INI.WertLesen("ColSize", "TMR6", "65")
            ...
            .Columns(ColNum.eSR6).Width = INI.WertLesen("ColSize", "SR6", "65")
            ...
            .Columns(ColNum.eRR6).Width = INI.WertLesen("ColSize", "RR6", "65")
    ...
    Private Sub WriteINIColSize()
        ...
        With DataGridView1
            ...
            INI.WertSchreiben("ColSize", "TPR6", .Columns(ColNum.eTPR6).Width)
            ...
            INI.WertSchreiben("ColSize", "TMR6", .Columns(ColNum.eTMR6).Width)
            ...
            INI.WertSchreiben("ColSize", "SR6", .Columns(ColNum.eSR6).Width)
            ...
            INI.WertSchreiben("ColSize", "RR6", .Columns(ColNum.eRR6).Width)
    ...
    Private Sub Form1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Windows.Forms.Keys.F Then
            If e.Control = True Then
                FormFilter.prop1() = FilterDatum
                Call FormFilter.ShowDialog()
                FilterDatum = FormFilter.prop1()
                If FilterDatum <> "" And Me.TextBox1.Text <> "" Then
                    Me.Text = "Biotop-Auswertung | Filter: " & FilterDatum
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With DataGridView1
            ...
            .Columns.Add("TransfPlusRap5", "+Rap.(last 3-6)")
            ...
            .Columns.Add("TransfMinusRap5", "-Rap.(last 3-6)")
            ...
            .Columns(ColNum.eTPR6).SortMode = DataGridViewColumnSortMode.Programmatic
            ...
            .Columns(ColNum.eTMR6).SortMode = DataGridViewColumnSortMode.Programmatic
            ...
            .Columns(ColNum.eSR6).SortMode = DataGridViewColumnSortMode.Programmatic
            ...
            .Columns(ColNum.eRR6).SortMode = DataGridViewColumnSortMode.Programmatic
    ...
    Private Sub SetSizeLabelColPos()        
        ...
        Label3.Width = DataGridView1.Columns.Item(ColNum.eTPS).Width + DataGridView1.Columns.Item(ColNum.eTPI).Width + DataGridView1.Columns.Item(ColNum.eTPR).Width + DataGridView1.Columns.Item(ColNum.eTPR6).Width + DataGridView1.Columns.Item(ColNum.eTPRS).Width

        Label4.Left = DataGridView1.GetCellDisplayRectangle(ColNum.eTMS, -1, True).Left + 10
        Label4.Top = DataGridView1.Top - Label4.Height
        Label4.Width = DataGridView1.Columns.Item(ColNum.eTMS).Width + DataGridView1.Columns.Item(ColNum.eTMI).Width + DataGridView1.Columns.Item(ColNum.eTMR).Width + DataGridView1.Columns.Item(ColNum.eTMR6).Width + DataGridView1.Columns.Item(ColNum.eTMRS).Width
        ...
        Label7.Width = DataGridView1.Columns.Item(ColNum.eSS).Width + DataGridView1.Columns.Item(ColNum.eSI).Width + DataGridView1.Columns.Item(ColNum.eSR).Width + DataGridView1.Columns.Item(ColNum.eSR6).Width + DataGridView1.Columns.Item(ColNum.eSRS).Width

        Label8.Left = DataGridView1.GetCellDisplayRectangle(ColNum.eRS, -1, True).Left + 10
        Label8.Top = DataGridView1.Top - Label4.Height
        Label8.Width = DataGridView1.Columns.Item(ColNum.eRS).Width + DataGridView1.Columns.Item(ColNum.eRI).Width + DataGridView1.Columns.Item(ColNum.eRR).Width + DataGridView1.Columns.Item(ColNum.eRR6).Width + DataGridView1.Columns.Item(ColNum.eRRS).Width
    ...
    Private Sub StartAuswertung()
        ...
        Dim TmpMaxSaldo As Integer = 0
        Dim GesSaldo As Integer = 0
        Dim GesZero As Integer = 0
        ...
        Using r As StreamReader = New StreamReader(TextBox1.Text)
            ...
            Do While (Not line Is Nothing)
                ...
                If IsNumeric(NewCoup) = True And (Len(NewCoup) = 2 Or Len(NewCoup) = 1) And nextDay = False Then
                    If filterfound = True Then
                        ...
                        If saldo = 2 And TmpMaxSaldo >= 3 Then
                            nextDay = True
                        ElseIf saldo = 3 And TmpMaxSaldo >= 5 Then
                            nextDay = True
                        ElseIf saldo = 5 And TmpMaxSaldo >= 8 Then
                            nextDay = True
                        ElseIf saldo = 9 Then
                            nextDay = True
                        ElseIf saldo = -6 Then
                        ...
                        If saldo > lastsaldo Then
                            ...
                            gesSaldoVerlaufNoZero = gesSaldoVerlaufNoZero & "+"
                        ElseIf saldo < lastsaldo Then
                            saldoverlauf = saldoverlauf & "- "
                            If lNewCoup > 0 Then gesSaldoVerlaufNoZero = gesSaldoVerlaufNoZero & "-"
                        End If
                ...
                Else
                    If InStr(line, "Datum") Then
                        ...
                        Else
                            If FilterDatum <> "" Then
                                If datum = FilterDatum And nextDay = True Then
                                    Exit Do
                                End If
                            End If
                        End If
                        ...
                        If nextDay = True Then
                            ...
                            ResTxt = ResTxt & datum & ": Saldo = " & saldo & " | Zero Verlust = " & zeroCnt & " | Anz. Sätze = " & SatzCnt & " | Max. Verlustserie = " & GesMaxloss & vbNewLine
                            ...
                            End If
                            GesZero = GesZero + zeroCnt
                            GesSatzCnt = GesSatzCnt + SatzCnt
                            gesSaldoVerlauf = gesSaldoVerlauf & saldoverlauf
            ...
            Else
                ResTxt = ResTxt & vbNewLine & "Gesamtsaldo: " & GesSaldo & vbNewLine
                ResTxt = ResTxt & "Gesamt Zero Verlust: " & GesZero & vbNewLine
    ...
    Private Sub InsertNewCoup(ByVal NewCoup As String, Optional ByVal dummySet As Boolean = False)
        ...
        Else
            ...
            R1.Cells(ColNum.eTPRS).Value = FillSatz(ColNum.eTPR6)
            R1.Cells(ColNum.eTMRS).Value = FillSatz(ColNum.eTMR6)
            R1.Cells(ColNum.eSRS).Value = FillSatz(ColNum.eSR6)
            R1.Cells(ColNum.eRRS).Value = FillSatz(ColNum.eRR6)
        End If
        ...
        R1.Cells(ColNum.eTPR6).Style.BackColor = Label3.BackColor
        ...
        R1.Cells(ColNum.eTMR6).Style.BackColor = Label4.BackColor
        ...
        R1.Cells(ColNum.eSR6).Style.BackColor = Label7.BackColor
        ...
        R1.Cells(ColNum.eSR6).Style.ForeColor = Color.White
        ...
        R1.Cells(ColNum.eRR6).Style.BackColor = Label8.BackColor
        ...
        R1.Cells(ColNum.eRR6).Style.ForeColor = Color.White
    ...
    Private Sub CalkSaldo()
        ...
        If saldo < tmpsaldo Then
            CntVerlust = CntVerlust + 1
            If cnt > 1 Then
                testsaldo = testsaldo - 1
            End If
        End If

        If saldo > tmpsaldo Then
            CntGewinn = CntGewinn + 1
            If cnt > 1 Then
                testsaldo = testsaldo + 1
            End If
        End If
    ...
    Private Sub fillSelektorPlusRap()
        ...
        If Rap <> "" Then
            DataGridView1.Rows(RowCount).Cells(ColNum.eTPR6).Value = GetRapLast6(ColNum.eTPR)
        End If
    End Sub
    ...
    Private Sub fillSelektorSchwarzRap()
        ...
        If Rap <> "" Then
            DataGridView1.Rows(RowCount).Cells(ColNum.eSR6).Value = GetRapLast6(ColNum.eSR)
        End If
    End Sub
    ...
    Private Sub fillSelektorRotRap()
        ...
        If Rap <> "" Then
            DataGridView1.Rows(RowCount).Cells(ColNum.eRR6).Value = GetRapLast6(ColNum.eRR)
        End If
    End Sub

    Private Function GetRapLast6(ByVal SelektorCol As Integer) As String
        Dim Rap As String = ""
    ...
    Private Function FillSatz(ByVal SelektorCol As Integer) As String
        ...
        If RapTmp <> "" Then
            ...
            Do Until I = 0
                Select Case I
                    Case 1
                        s1 = RapTmp.Substring(I - 1, 1)
                    Case 2
                        s2 = RapTmp.Substring(I - 1, 1)
                    Case 3
                        s3 = RapTmp.Substring(I - 1, 1)
                    Case 4
                        s4 = RapTmp.Substring(I - 1, 1)
                    Case 5
                        s5 = RapTmp.Substring(I - 1, 1)
                    Case 6
                        s6 = RapTmp.Substring(I - 1, 1)
                End Select

                I = I - 1
            Loop

            If RapTmp.Length = 3 Then
                s6 = s3
                s5 = s2
                s4 = s1
                s3 = ""
            ...
            ''Regel10 XXX(X) | OOO(O)
            'If (s6 = s5 And s6 = s4) Then
            '    If (s6 <> s3) Then
            '        ReturnStr = "R10: " & s6 & s5 & s4 & "(" & s6 & ")"
            ...
            ''Regel12 XXO(O) | OOX(X)
            'If (s6 <> s5 And s5 = s4) Then
            '    If Not ((s3 = s6) And (s2 = s3)) Then
            '        ReturnStr = "R12: " & s4 & s5 & s6 & "(" & s6 & ")"
            '        SatzCount = SatzCount + 1
            '        Call SetSatz(s6, SelektorCol)
            '    Else
            ...
            'If (s6 <> s5 And s5 <> s4 And s4 = s3 And s3 <> s2) Then
            '    ReturnStr = "R13: " & s2 & s3 & s4 & s5 & s6 & "(" & s6 & ")"
            '    SatzCount = SatzCount + 1
            '    FillSatz = ReturnStr
            '    Call SetSatz(s6, SelektorCol)
            '    Exit Function            
            '    'XXOXX(O) | OOXOO(X)
            'ElseIf (s6 = s5 And s5 <> s4 And s4 <> s3 And s3 = s2) Then
            '    If (s6 <> s5 And s5 <> s4 And s4 = s3 And s3 <> s2) Then
            '        ReturnStr = "R13: " & s2 & s3 & s4 & s5 & s6 & "(" & s4 & ")"
            '        SatzCount = SatzCount + 1
            '        FillSatz = ReturnStr
            ...
            If (s6 = s5 And s6 = s4) Then
                If (s6 <> s3) Then
                    ...
                    ReturnStr = "R10: " & s6 & s5 & s4 & "(" & s & ")"
                    SatzCount = SatzCount + 1
                    Call SetSatz(s, SelektorCol)
                Else
                    ReturnStr = "R10: Not Aborted"
                End If
                FillSatz = ReturnStr
            ...
            'Regel13 OXXOX(X) | XOOXO(O)
            If (s6 <> s5 And s5 <> s4 And s4 = s3 And s3 <> s2) Then
                ReturnStr = "R13: " & s2 & s3 & s4 & s5 & s6 & "(" & s5 & ")"
                SatzCount = SatzCount + 1
                FillSatz = ReturnStr
                Call SetSatz(s5, SelektorCol)
                Exit Function
    ...
    Private Sub fillSelektorMinusRap()
        ...
        If Rap <> "" Then
            DataGridView1.Rows(RowCount).Cells(ColNum.eTMR6).Value = GetRapLast6(ColNum.eTMR)
        End If
    ...
    Private Function GetColWidth() As Integer
        ...
        DataGridView1.Columns.Item(ColNum.eTPR6).Width + _
        ...
        DataGridView1.Columns.Item(ColNum.eTMR6).Width + _
        ...
        DataGridView1.Columns.Item(ColNum.eSR6).Width + _
        ...
        DataGridView1.Columns.Item(ColNum.eRR6).Width + _
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        FormRes.prop1() = ResTxt
        FormRes.SaldoVerlauf1 = gesSaldoVerlauf
        FormRes.SaldoVerlaufNoZero = gesSaldoVerlaufNoZero
        Call FormRes.ShowDialog()
        Me.Update()
    End Sub
    ...
    Private Function GetResult() As String
        ...
        stxt = stxt & "Zero Verlust: " & zeroCnt & vbNewLine
        ...
        stxt = stxt & vbNewLine
        stxt = stxt & "Saldo nur dopppl: " & testsaldo & vbNewLine
